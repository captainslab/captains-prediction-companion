...
- No final picks.
- No trades placed.
- Kalshi same-day market discovery found 30 valid records.
- Missing before full guide: usable Savant/Statcast evidence, liquidity/order book, morning scan composer.

## Source Health

- Kalshi: degraded
- MLB official: ok
- Baseball Savant: blocked
- Weather: ok
- Liquidity: blocked
- Sportsbook reference: ok
- Lineup/injury/bullpen: ok
- Optional price sanity: skipped
- Kalshi records kept: 30
- Kalshi rejected diagnostic records: 98
- Baseball Savant records: 0
- Weather records: 17
- Liquidity records: 0
- Sportsbook reference records: 15
- Context records: 15
- Kalshi warnings: Kalshi calendar inaccessible or challenge-gated: HTTP 429.
- Baseball Savant warnings: Live read-only Statcast CSV checked; Stage 4 records discovery summaries only and makes no picks.; No usable Statcast rows were returned; MLB schedule context was not emitted as Baseball Savant evidence.
- Baseball Savant errors: none
- Weather warnings: Live read-only weather records are environment inputs only, not final model evidence or recommendations.
- Weather errors: none
- Liquidity warnings: No Kalshi market tickers provided; cannot fetch liquidity.
- Liquidity errors: none
- Sportsbook warnings: Sportsbook reference records are not Kalshi prices and are never executable prices.
- Context warnings: Lineup pending is a disclosed evidence state, not a full-slate blocker.

## Slate Overview

| Game | Start | Kalshi markets listed | MLB status | Weather note | Source status |
|---|---|---|---|---|---|
| Toronto Blue Jays at Detroit Tigers | 2026-05-16T17:10:00Z | moneyline, game_total | Pre-Game | adapter checked | MLB ok; Kalshi degraded; Savant blocked; weather ok |
| Kansas City Royals at St. Louis Cardinals | 2026-05-16T18:15:00Z | moneyline, game_total | Scheduled | adapter checked | MLB ok; Kalshi degraded; Savant blocked; weather ok |
| Arizona Diamondbacks at Colorado Rockies | 2026-05-16T19:10:00Z | moneyline, game_total | Scheduled | adapter checked | MLB ok; Kalshi degraded; Savant blocked; weather ok |
| Baltimore Orioles at Washington Nationals | 2026-05-16T20:05:00Z | moneyline, game_total | Scheduled | adapter checked | MLB ok; Kalshi degraded; Savant blocked; weather ok |
| Philadelphia Phillies at Pittsburgh Pirates | 2026-05-16T20:05:00Z | moneyline, game_total | Scheduled | adapter checked | MLB ok; Kalshi degraded; Savant blocked; weather ok |
| Miami Marlins at Tampa Bay Rays | 2026-05-16T20:10:00Z | moneyline, game_total | Scheduled | adapter checked | MLB ok; Kalshi degraded; Savant blocked; weather ok |
| Cincinnati Reds at Cleveland Guardians | 2026-05-16T22:10:00Z | moneyline, game_total | Scheduled | adapter checked | MLB ok; Kalshi degraded; Savant blocked; weather ok |
| Texas Rangers at Houston Astros | 2026-05-16T23:10:00Z | moneyline, game_total | Scheduled | adapter checked | MLB ok; Kalshi degraded; Savant blocked; weather ok |
| Chicago Cubs at Chicago White Sox | 2026-05-16T23:10:00Z | moneyline, game_total | Scheduled | adapter checked | MLB ok; Kalshi degraded; Savant blocked; weather ok |
| Milwaukee Brewers at Minnesota Twins | 2026-05-16T23:10:00Z | moneyline, game_total | Scheduled | adapter checked | MLB ok; Kalshi degraded; Savant blocked; weather ok |
| San Diego Padres at Seattle Mariners | 2026-05-16T23:15:00Z | moneyline, game_total | Scheduled | adapter checked | MLB ok; Kalshi degraded; Savant blocked; weather ok |
| Boston Red Sox at Atlanta Braves | 2026-05-16T23:15:00Z | moneyline, game_total | Scheduled | adapter checked | MLB ok; Kalshi degraded; Savant blocked; weather ok |
| New York Yankees at New York Mets | 2026-05-16T23:15:00Z | moneyline, game_total | Scheduled | adapter checked | MLB ok; Kalshi degraded; Savant blocked; weather ok |
| Los Angeles Dodgers at Los Angeles Angels | 2026-05-17T01:38:00Z | moneyline, game_total | Scheduled | adapter checked | MLB ok; Kalshi degraded; Savant blocked; weather ok |
| San Francisco Giants at Athletics | 2026-05-17T01:40:00Z | moneyline, game_total | Scheduled | adapter checked | MLB ok; Kalshi degraded; Savant blocked; weather ok |
