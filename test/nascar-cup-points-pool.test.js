...
test('Coca-Cola 600 ceiling_board.json on disk uses candidate_pool_basis=cup_points_top_20', () => {
  ...
  // Tyler Reddick is points #1 per the snapshot and must lead the pool.
